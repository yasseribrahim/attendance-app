package com.student.attendance.app.fragments.users.teacher;
...
import com.student.attendance.app.activities.CourseDetailsActivity;
import com.student.attendance.app.adapters.CoursesAdapter;
...
public class CoursesFragment extends Fragment implements CoursesCallback, CoursesAdapter.OnItemClickListener {
    ...
    private void load() {
        presenter.getCoursesByLecturerId(lecturerId);
    }
